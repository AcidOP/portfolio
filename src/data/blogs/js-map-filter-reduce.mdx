...
tags: ['cheatsheet']
draft: false
description: 'Learn the basics of Map, Filter, and Reduce in JavaScript. Simplify array operations for more readable and efficient code. '
...
const numbers = [1, 2, 3, 4, 5];
const doubledNumbers = numbers.map(number => number * 2); // [!code highlight]
