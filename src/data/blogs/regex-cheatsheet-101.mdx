...
tags: ['cheatsheet']
draft: false
description: Regex, or regular expressions, can be a bit tricky to learn, but once you get the hang of it, you'll be able to match and manipulate strings like a pro. In this cheatsheet, we'll go over some of the most important concepts and expressions in regex. Don't worry, we'll keep it fun and easy to understand!
cover: '/blogs/regex-cheatsheet-101/cover.jpg'
---
