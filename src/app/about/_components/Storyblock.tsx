...
const Storyblock: FC = () => {
  return (
    <div className='mx-auto mb-16 flex w-full max-w-[calc(100vw-2.5rem)] flex-col justify-between rounded-3xl bg-violet-700 p-16 lg:max-w-[calc(100vw-8rem)] lg:flex-row'>
      <div className='flex flex-col justify-between text-white'>
        ...
        <div>
          ...
          <p className='my-8 opacity-80 lg:mb-0'>
