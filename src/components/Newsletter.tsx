...
const Newsletter: FC = () => {
  ...
  return (
    <div>
      <p className='font-medium mb-2 opacity-70'>
        Join our newsletter to get updates on new things in our
        community.
      </p>
      ...
      <div className="flex flex-row items-center my-3 w-full">
        ...
        <p className='pl-6'>and <span className="text-violet-600 font-semibold">136+ </span>others are subscribed</p>
      </div>
